...
target("player_test")
    ...
    add_files("src/base/base.c")
    add_files("src/object/object.c")
    add_files("src/custom/units/player_object.c")
    add_files("src/custom/units/obstacles.c")
    add_files("src/custom/units/bullets.c")
    add_files("src/custom/units/tower.c")
    add_files("src/custom/skills/shoot.c")
    add_files("src/custom/skills/place_tesla.c")
